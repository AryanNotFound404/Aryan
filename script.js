    ...
    <div class="glass-card rounded-2xl p-6 sm:p-10 lg:p-12 w-full transition-all duration-300">
      <div class="flex flex-col md:flex-row md:items-center justify-between pb-6 mb-8 border-b border-purple-500/20 gap-4">
        ...
        <div class="flex items-center gap-3">
          <span class="text-xs font-mono text-zinc-400">Total Shipped: <strong class="text-purple-300">50+</strong></span>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-purple-500/20 gap-4">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="https://www.fiverr.com/aryannotpresent" target="_blank" class="glow-btn-outline px-5 py-2 rounded-full text-zinc-300 text-xs font-semibold flex items-center gap-1.5">
  ...
  'store': `
    <div class="glass-card rounded-2xl p-6 sm:p-10 lg:p-12 w-full transition-all duration-300">
      <div class="flex flex-col md:flex-row md:items-center justify-between pb-6 mb-8 border-b border-purple-500/20 gap-4">
        <div>
          <span class="font-mono text-xs tracking-widest text-cyan-400 uppercase font-semibold block mb-1">
            — DIGITAL PRODUCTS ON XENON MARKET
          </span>
          <h3 class="text-2xl sm:text-3xl lg:text-4xl font-black text-white">
            Ready-to-Deploy Products & Licenses
          </h3>
        </div>
        <a href="https://www.fiverr.com/aryannotpresent" target="_blank" 
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 flex flex-col justify-between hover:border-purple-400/50 transition-all">
          <div>
            <span class="text-xs font-mono text-purple-400 uppercase block mb-1">Source Code License</span>
            <h4 class="text-lg font-bold text-white mb-2">Veltrix Bot Core Edition</h4>
            <p class="text-zinc-300 text-xs leading-relaxed mb-4">
              Turnkey discord.js v14 bot template with full economy engine, mongoDB schema, and command handlers.
            </p>
          </div>
          <div class="flex items-center justify-between pt-4 border-t border-purple-900/40 font-mono">
            ...
            <span class="text-xs text-cyan-400">Instant Download</span>
          </div>
        </div>

        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 flex flex-col justify-between hover:border-purple-400/50 transition-all">
          <div>
            <span class="text-xs font-mono text-pink-400 uppercase block mb-1">Asset Pack</span>
            <h4 class="text-lg font-bold text-white mb-2">Promo Social Drops Vol. 1</h4>
            <p class="text-zinc-300 text-xs leading-relaxed mb-4">
              20+ layered Photoshop & After Effects animated teaser banners built specifically for Discord servers.
            </p>
          </div>
          <div class="flex items-center justify-between pt-4 border-t border-purple-900/40 font-mono">
            <span class="text-white font-bold text-sm">$15.00</span>
            <span class="text-xs text-pink-400">Instant Assets</span>
          </div>
        </div>

        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 flex flex-col justify-between hover:border-purple-400/50 transition-all">
          <div>
            <span class="text-xs font-mono text-teal-400 uppercase block mb-1">Automation Script</span>
            <h4 class="text-lg font-bold text-white mb-2">Discord Webhook & Scraper</h4>
            <p class="text-zinc-300 text-xs leading-relaxed mb-4">
              Python tool for scheduled automated announcements, member monitoring, and proxy-rotated webhooks.
            </p>
          </div>
          <div class="flex items-center justify-between pt-4 border-t border-purple-900/40 font-mono">
            <span class="text-white font-bold text-sm">$35.00</span>
            <span class="text-xs text-teal-400">Python Script</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="glass-card rounded-2xl p-6 sm:p-10 lg:p-12 w-full transition-all duration-300">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 hover:border-purple-400/50 transition-all">
          ...
          <h4 class="text-xl font-bold text-white mb-2">Hauser.lol Developer Site</h4>
          <p class="text-zinc-300 text-xs sm:text-sm leading-relaxed mb-4">
        ...
        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 hover:border-purple-400/50 transition-all">
          ...
          <h4 class="text-xl font-bold text-white mb-2">Xenon Market Hub</h4>
          <p class="text-zinc-300 text-xs sm:text-sm leading-relaxed mb-4">
            Conversion-focused digital products marketplace with instant checkout, live order stream, dark glassmorphic layout, and responsive mobile UX.
          </p>
          <div class="flex gap-2 font-mono text-[10px] text-zinc-400">
        ...
        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 hover:border-purple-400/50 transition-all">
          <span class="text-xs font-mono text-teal-400 uppercase block mb-1">SaaS Web Application</span>
          <h4 class="text-xl font-bold text-white mb-2">CyberVault Analytics UI</h4>
          <p class="text-zinc-300 text-xs sm:text-sm leading-relaxed mb-4">
            Analytics platform with real-time graph telemetry, token usage monitoring, user tier upgrades, and dark cyber ambient lighting.
          </p>
          <div class="flex gap-2 font-mono text-[10px] text-zinc-400">
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">React</span>
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">Chart.js</span>
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">Tailwind</span>
          </div>
        </div>

        <div class="rounded-xl border border-purple-500/20 bg-purple-950/20 p-6 hover:border-purple-400/50 transition-all">
          <span class="text-xs font-mono text-pink-400 uppercase block mb-1">Landing Page</span>
          <h4 class="text-xl font-bold text-white mb-2">Creator LinkTree & Launch Pad</h4>
          <p class="text-zinc-300 text-xs sm:text-sm leading-relaxed mb-4">
            Ultra-fast mobile-optimized promo link page with animated social tiles, embedded reels, and automated discord join trackers.
          </p>
          <div class="flex gap-2 font-mono text-[10px] text-zinc-400">
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">PWA</span>
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">CSS Motion</span>
            <span class="px-2 py-0.5 bg-black/40 rounded border border-zinc-800">Netlify</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        <a href="https://discord.com/users/1208641341559676948" target="_blank" 
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h4 class="text-white font-bold group-hover:text-cyan-300 text-sm">Discord: Hauser</h4>
        ...
        <a href="https://www.fiverr.com/aryannotpresent" target="_blank" 
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              <h4 class="text-white font-bold group-hover:text-purple-300 text-sm">Xenon Market Shop</h4>
              <p class="text-zinc-400 text-xs font-mono">xenonmarket.mysellauth.com</p>
            </div>
          </div>
          <i data-lucide="arrow-up-right" class="w-4 h-4 text-zinc-500 group-hover:text-white transition-colors"></i>
        </a>
        ...
        <a href="https://twitter.com" target="_blank" 
           class="p-5 rounded-xl border border-purple-500/20 bg-purple-950/20 hover:border-pink-400/50 flex items-center justify-between group transition-all">
          <div class="flex items-center gap-3">
            <i data-lucide="twitter" class="w-5 h-5 text-pink-400"></i>
            <div>
              <h4 class="text-white font-bold group-hover:text-pink-300 text-sm">Twitter / X</h4>
              <p class="text-zinc-400 text-xs font-mono">Launch drops & dev teasers</p>
            </div>
          </div>
          <i data-lucide="arrow-up-right" class="w-4 h-4 text-zinc-500 group-hover:text-white transition-colors"></i>
        </a>
